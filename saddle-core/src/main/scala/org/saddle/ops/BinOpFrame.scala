...
/** Provides concrete implementations of binary operations for
  * [[org.saddle.Frame]]; these instances provide implicit support for
  * [[org.saddle.ops.NumericOps]] methods which are inherited by Frame.
  */
trait BinOpFrame {
  // ***************

  // Binary element-wise operation on one frame and one scalar
  final class FrScEOp[OP <: ScalarOp, X, Y, A, B, C: ST](
  ...
  ): FrScEOp[Op, X, Y, Double, Double, Double] =
  ...
  ): FrScEOp[Op, X, Y, Double, Long, Double] =
  ...
  ): FrScEOp[Op, X, Y, Double, Int, Double] =
  ...
  ): FrScEOp[Op, X, Y, Long, Double, Double] =
  ...
  ): FrScEOp[Op, X, Y, Int, Double, Double] =
  ...
  ): FrScEOp[Op, X, Y, Double, Double, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Double, Long, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Double, Int, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Long, Double, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Long, Long, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Long, Int, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Int, Double, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Int, Long, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Int, Int, Boolean] =
  ...
  ): FrScEOp[Op, X, Y, Boolean, Boolean, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Double, Double, Double] =
  ...
  ): FrFrEOp[Op, X, Y, Double, Int, Double] =
  ...
  ): FrFrEOp[Op, X, Y, Double, Long, Double] =
  ...
  ): FrFrEOp[Op, X, Y, Long, Double, Double] =
  ...
  ): FrFrEOp[Op, X, Y, Int, Double, Double] =
  ...
  ): FrFrEOp[Op, X, Y, Double, Double, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Double, Long, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Double, Int, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Long, Double, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Long, Long, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Long, Int, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Int, Double, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Int, Long, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Int, Int, Boolean] =
  ...
  ): FrFrEOp[Op, X, Y, Boolean, Boolean, Boolean] =
