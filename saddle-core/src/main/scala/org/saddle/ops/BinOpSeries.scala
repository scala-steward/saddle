...
import org.saddle.{ST, Vec, Series, ORD}
import org.saddle.index.OuterJoin

/** Provides concrete implementations of binary operations for
  * [[org.saddle.Series]]; these instances provide implicit support for
  * [[org.saddle.ops.NumericOps]] methods which are inherited by Series.
  */
trait BinOpSeries {
  // ***************
  ...
  implicit def SrScEOpDDD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Double, Vec[Double]]
  ): SrScEOp[Op, X, Double, Double, Double] =
    new SrScEOp[Op, X, Double, Double, Double](opv)
  implicit def SrScEOpDLD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Long, Vec[Double]]
  ): SrScEOp[Op, X, Double, Long, Double] =
    new SrScEOp[Op, X, Double, Long, Double](opv)
  implicit def SrScEOpDID[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Int, Vec[Double]]
  ): SrScEOp[Op, X, Double, Int, Double] =
    new SrScEOp[Op, X, Double, Int, Double](opv)

  implicit def SrScEOpLDD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Double, Vec[Double]]
  ): SrScEOp[Op, X, Long, Double, Double] =
    new SrScEOp[Op, X, Long, Double, Double](opv)
  implicit def SrScEOpLLL[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Long, Vec[Long]]
  ): SrScEOp[Op, X, Long, Long, Long] =
    new SrScEOp[Op, X, Long, Long, Long](opv)
  implicit def SrScEOpLIL[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Int, Vec[Long]]
  ): SrScEOp[Op, X, Long, Int, Long] = new SrScEOp[Op, X, Long, Int, Long](opv)

  implicit def SrScEOpIDD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Double, Vec[Double]]
  ): SrScEOp[Op, X, Int, Double, Double] =
    new SrScEOp[Op, X, Int, Double, Double](opv)
  implicit def SrScEOpILL[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Long, Vec[Long]]
  ): SrScEOp[Op, X, Int, Long, Long] = new SrScEOp[Op, X, Int, Long, Long](opv)
  implicit def SrScEOpIII[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Int, Vec[Int]]
  ): SrScEOp[Op, X, Int, Int, Int] = new SrScEOp[Op, X, Int, Int, Int](opv)

  // comparisons
  implicit def SrScEOpDDB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Double, Vec[Boolean]]
  ): SrScEOp[Op, X, Double, Double, Boolean] =
    new SrScEOp[Op, X, Double, Double, Boolean](opv)
  implicit def SrScEOpDLB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Long, Vec[Boolean]]
  ): SrScEOp[Op, X, Double, Long, Boolean] =
    new SrScEOp[Op, X, Double, Long, Boolean](opv)
  implicit def SrScEOpDIB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Int, Vec[Boolean]]
  ): SrScEOp[Op, X, Double, Int, Boolean] =
    new SrScEOp[Op, X, Double, Int, Boolean](opv)

  implicit def SrScEOpLDB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Double, Vec[Boolean]]
  ): SrScEOp[Op, X, Long, Double, Boolean] =
    new SrScEOp[Op, X, Long, Double, Boolean](opv)
  implicit def SrScEOpLLB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Long, Vec[Boolean]]
  ): SrScEOp[Op, X, Long, Long, Boolean] =
    new SrScEOp[Op, X, Long, Long, Boolean](opv)
  implicit def SrScEOpLIB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Int, Vec[Boolean]]
  ): SrScEOp[Op, X, Long, Int, Boolean] =
    new SrScEOp[Op, X, Long, Int, Boolean](opv)

  implicit def SrScEOpIDB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Double, Vec[Boolean]]
  ): SrScEOp[Op, X, Int, Double, Boolean] =
    new SrScEOp[Op, X, Int, Double, Boolean](opv)
  implicit def SrScEOpILB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Long, Vec[Boolean]]
  ): SrScEOp[Op, X, Int, Long, Boolean] =
    new SrScEOp[Op, X, Int, Long, Boolean](opv)
  implicit def SrScEOpIIB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Int, Vec[Boolean]]
  ): SrScEOp[Op, X, Int, Int, Boolean] =
    new SrScEOp[Op, X, Int, Int, Boolean](opv)

  // and, or ops
  implicit def SrScEOpBBB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Boolean], Boolean, Vec[Boolean]]
  ): SrScEOp[Op, X, Boolean, Boolean, Boolean] =
  ...
  implicit def SrSrEOpDDD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Vec[Double], Vec[Double]]
  ): SrSrEOp[Op, X, Double, Double, Double] =
    new SrSrEOp[Op, X, Double, Double, Double](opv)
  implicit def SrSrEOpDID[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Vec[Int], Vec[Double]]
  ): SrSrEOp[Op, X, Double, Int, Double] =
    new SrSrEOp[Op, X, Double, Int, Double](opv)
  implicit def SrSrEOpDLD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Vec[Long], Vec[Double]]
  ): SrSrEOp[Op, X, Double, Long, Double] =
    new SrSrEOp[Op, X, Double, Long, Double](opv)

  implicit def SrSrEOpLDD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Vec[Double], Vec[Double]]
  ): SrSrEOp[Op, X, Long, Double, Double] =
    new SrSrEOp[Op, X, Long, Double, Double](opv)
  implicit def SrSrEOpLLL[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Vec[Long], Vec[Long]]
  ): SrSrEOp[Op, X, Long, Long, Long] =
    new SrSrEOp[Op, X, Long, Long, Long](opv)
  implicit def SrSrEOpLIL[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Vec[Int], Vec[Long]]
  ): SrSrEOp[Op, X, Long, Int, Long] = new SrSrEOp[Op, X, Long, Int, Long](opv)

  implicit def SrSrEOpIDD[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Vec[Double], Vec[Double]]
  ): SrSrEOp[Op, X, Int, Double, Double] =
    new SrSrEOp[Op, X, Int, Double, Double](opv)
  implicit def SrSrEOpILL[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Vec[Long], Vec[Long]]
  ): SrSrEOp[Op, X, Int, Long, Long] = new SrSrEOp[Op, X, Int, Long, Long](opv)
  implicit def SrSrEOpIII[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Vec[Int], Vec[Int]]
  ): SrSrEOp[Op, X, Int, Int, Int] = new SrSrEOp[Op, X, Int, Int, Int](opv)

  // comparisons
  implicit def SrSrEOpDDB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Vec[Double], Vec[Boolean]]
  ): SrSrEOp[Op, X, Double, Double, Boolean] =
    new SrSrEOp[Op, X, Double, Double, Boolean](opv)
  implicit def SrSrEOpDLB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Vec[Long], Vec[Boolean]]
  ): SrSrEOp[Op, X, Double, Long, Boolean] =
    new SrSrEOp[Op, X, Double, Long, Boolean](opv)
  implicit def SrSrEOpDIB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Double], Vec[Int], Vec[Boolean]]
  ): SrSrEOp[Op, X, Double, Int, Boolean] =
    new SrSrEOp[Op, X, Double, Int, Boolean](opv)

  implicit def SrSrEOpLDB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Vec[Double], Vec[Boolean]]
  ): SrSrEOp[Op, X, Long, Double, Boolean] =
    new SrSrEOp[Op, X, Long, Double, Boolean](opv)
  implicit def SrSrEOpLLB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Vec[Long], Vec[Boolean]]
  ): SrSrEOp[Op, X, Long, Long, Boolean] =
    new SrSrEOp[Op, X, Long, Long, Boolean](opv)
  implicit def SrSrEOpLIB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Long], Vec[Int], Vec[Boolean]]
  ): SrSrEOp[Op, X, Long, Int, Boolean] =
    new SrSrEOp[Op, X, Long, Int, Boolean](opv)

  implicit def SrSrEOpIDB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Vec[Double], Vec[Boolean]]
  ): SrSrEOp[Op, X, Int, Double, Boolean] =
    new SrSrEOp[Op, X, Int, Double, Boolean](opv)
  implicit def SrSrEOpILB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Vec[Long], Vec[Boolean]]
  ): SrSrEOp[Op, X, Int, Long, Boolean] =
    new SrSrEOp[Op, X, Int, Long, Boolean](opv)
  implicit def SrSrEOpIIB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Int], Vec[Int], Vec[Boolean]]
  ): SrSrEOp[Op, X, Int, Int, Boolean] =
    new SrSrEOp[Op, X, Int, Int, Boolean](opv)

  // and, or ops
  implicit def SrSrEOpBBB[Op <: ScalarOp, X](implicit
      cm: ST[X],
      cmp: ORD[X],
      opv: BinOp[Op, Vec[Boolean], Vec[Boolean], Vec[Boolean]]
  ): SrSrEOp[Op, X, Boolean, Boolean, Boolean] =
